...
@Component({
  ...
  templateUrl: './minesweeper-gametable.component.html',
  styleUrls: ['./minesweeper-gametable.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class MinesweeperGametableComponent implements OnInit, DoCheck {
  ...
  private boolEmitterEnabled: boolean;
  ...
  private stopTheGameTimer() {
    
    if(this.minesweeperGame?.isGameFinished() == true && this.boolEmitterEnabled == true) {

      this.boolEmitterEnabled = false;
      this.timerStatusEmitter.emit(TimerStatus.STOP);
    }
  }

  private restartTheGameTimer() {

    if(this.minesweeperGame?.isGameFinished() == false && this.boolEmitterEnabled == false) {

      this.boolEmitterEnabled = true;
      this.timerStatusEmitter.emit(TimerStatus.START);
    }

    if(this.minesweeperGame?.isGameFinished() == false && this.boolEmitterEnabled == true) {
